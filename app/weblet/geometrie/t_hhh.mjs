...
//
// datei: weblet/geometrie/t_hhh.mjs
//================================================================================
'use strict';
...
class MneTemplateT_HHH
{
  static mkTemplate( weblet, slider )
  {
    ...
    var s2 = weblet.obj.slider.s2 = new MneHSlider(s1.container1, (slider['s2'] ) ? slider['s2'] : '33%', 'move');
    ...
    weblet.obj.container['middle']         = s3.container0
