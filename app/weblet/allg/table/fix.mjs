...
class MneTable extends MneViewContainer
{
  ...
  async load()
  {
    ...
    this.obj.whereobserver = new MutationObserver( (mutations, server) => { this.obj.container.weblet.style.top = whereframe.offsetHeight + 'px' });
    ...
    this.obj.weblets.table.newvalues = true;
    ...
    if ( this.initpar.whereweblet != undefined )
    {
      ...
      this.obj.weblets.where.newvalues = true;
